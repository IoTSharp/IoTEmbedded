...
static const board_resource_t pandora_resources[] = {
  ...
  },
  {
    ...
    .status = PANDORA_RESOURCE_STATUS_READY,
    .bus = "SPI3 + GPIO",
    .pins = "PB3 SCK, PB5 MOSI, PD7 CS, PB4 DC, PB6 RES, PB7 PWR",
    .protocol = "4-wire SPI, 240x240 RGB565 ST7789",
    .notes = "SPI3 is driven by the board layer because this CubeMX import does not generate an hspi3 HAL module.",
